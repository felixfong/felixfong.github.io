import{e as n}from"./app.28921fa4.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<p>\u6CE8\uFF1A\u6B64\u6587\u6863\u6839\u636E\u6155\u8BFE\u7F51 k8s \u89C6\u9891\u6559\u7A0B\u5B66\u4E60\u6574\u7406\u800C\u6210\u3002</p><h2 id="_1-\u521B\u5EFA\u4E00\u4E2A-nginx-\u7684-pod\u3002" tabindex="-1"><a class="header-anchor" href="#_1-\u521B\u5EFA\u4E00\u4E2A-nginx-\u7684-pod\u3002" aria-hidden="true">#</a> 1\uFF0C\u521B\u5EFA\u4E00\u4E2A nginx \u7684 pod\u3002</h2><p>\u5B9A\u4E49\u4E86\u4E00\u4E2A nginx.yaml \u7684\u6587\u4EF6\uFF1A</p><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token punctuation">[</span>root@master pod<span class="token punctuation">-</span>basic<span class="token punctuation">]</span>$cat pod_nginx.yml
